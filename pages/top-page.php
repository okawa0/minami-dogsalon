...
<div class="voice">
  ...
  <div class="voice-cards">
    <svg preserveAspectRatio="xMidYMid meet" data-bbox="0.4 0.4 55.2 38" viewBox="0.4 0.4 55.2 38" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true">
      <defs>
        <style>
          #comp-jt8o74qj8 svg [data-color="1"] {
            fill: #363C45;
          }
        </style>
      </defs>
      <g>
        <path d="M25.7 25.6c-1.4 2.7-3.2 4.9-5.5 6.8-2.3 1.9-4.9 3.3-8 4.4-3.1 1.1-6.2 1.6-9.4 1.6v-2c4.7-.9 8.3-2.4 10.9-4.5 2.6-2.1 3.9-5.2 3.9-9.5 0-1.2-.1-2.3-.4-3.3-.3-1-.5-1.8-.8-2.5-1.2.9-2.5 1.6-4 1.9-1.5.3-2.7.5-3.8.5-2.7 0-4.7-.9-6.1-2.7C1.1 14.5.4 12.6.4 10.6.4 7.3 1.6 4.7 4.1 3 6.6 1.3 9.3.4 12.4.4c4.5 0 8.2 1.6 11.1 4.8 2.9 3.2 4.3 7 4.3 11.4 0 3.3-.7 6.3-2.1 9z" fill="#4fd0ce" data-color="1"></path>
    ...
    <p>「お客様の声の例です。ここをクリックして顧客のメッセージを入力してください。」</p>
